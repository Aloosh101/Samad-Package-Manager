...
```bash
curl -fsSL https://github.com/aloosh101/spm/releases/latest/download/install.sh | bash
```
...
[releases page](https://github.com/aloosh101/spm/releases):

```bash
# Example: x86_64 Linux
wget https://github.com/aloosh101/spm/releases/latest/download/spm-x86_64-linux-gnu
